...
android {
    ...
    dependencies {
        ...
        // CHATTERLOOP PATCH: the disk cache (ChatterloopPlayback). Both already come in through
        // media3-exoplayer; named so the cache doesn't rest on a transitive dependency.
