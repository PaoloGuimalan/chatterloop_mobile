      ...
      _SettingsCategory(
        ...
        [
          _SettingsItem(
              ...
              "Change name, birthdate, and other public info",
              () => context.push('/profile/edit')),
          _SettingsItem(Icons.alternate_email, "Credentials",
              "Update your username", () => context.push('/profile/edit')),
          const _SettingsItem(Icons.privacy_tip_outlined, "Data & Privacy",
              "Export a copy of your data or delete your account", null),
          const _SettingsItem(Icons.devices_outlined, "Device Sessions",
              "See where you're logged in", null),
